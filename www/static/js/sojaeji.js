...
/* sojaeji.js -사용 광고주['더메인스튜디오', '패밀리유'] ============!!!*/
...
sojaeji.prototype = {
	update_gugun : function() {
		...
		var useAddText = 
			(typeof hbEvent != "undefined" && typeof hbEvent[0] != "undefined" 
			&& typeof hbEvent[0].advertiser != 'undefined' && hbEvent[0].advertiser == '패밀리유'
			&& typeof hbEvent[0].media != 'undefined' && hbEvent[0].media.match(/카카오/) != null  //매체가 카카오면 미사용
			)
			? false : true;
		for(var i=0; i<gugun.length; i++) {
			var addText = '';
			if(i && useAddText && ((this.sido.value == '서울' && $.inArray(gugun[i], ['관악구', '도봉구', '성북구', '중랑구'])<0)
...
'충남' : ['선택하세요','계룡시','공주시','금산군','논산시','당진시'/*,'보령시'*/,'부여군','서산시'/*,'서천군'*/,'아산시'/*,'연기군','예산군','천안시','천안북구','천안남구','청양군','홍성군'*/,'태안군'],
